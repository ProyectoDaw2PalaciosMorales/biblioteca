...
<body>
 <h1>Formulario de Actualizacion</h1>
        <form action="<?=base_url()?>Actualizar_autores/actualizarpost" method="post">
           ...
           <button> <a href="<?=base_url()?>Administrador_mostrarautores/mostrar_autores">Volver a la tabla</a> </button>
            <br><br>
