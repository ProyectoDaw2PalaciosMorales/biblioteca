...
class Actualizarperfil extends CI_Controller {
    ...
    public function actualizar(){
        ...
        if(isset( $_SESSION['nombre']) &&  $_SESSION['password']){
            ...
            $this->load->view('usuario/actualizarusuario',$datos);
        }
    ...
    public function actulizarperfilpost()
    {
        ...
        $this->Actu_perfil->actualizarperfil($id,$nombre,$primer_apellido,$segundo_apellido,$ano,$email,$telefono,$password,$comprobacion,$alias,$foto);
