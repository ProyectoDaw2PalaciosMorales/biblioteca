...
class Mostrarlibros extends CI_Controller {
    ...
    if(isset( $_SESSION['nombre']) &&  $_SESSION['password']){
        $this->load->model('Mostrar_libros');
         ...
         $this->load->view('mostrar_librosinsercion',$datos);}
    ...
    if(isset( $_SESSION['nombre']) &&  $_SESSION['password']){
        ...
        $this->load->view('autoresinsertados',$datos);
    ...
    if(isset( $_SESSION['nombre']) &&  $_SESSION['password']){
     ...
     $this->load->view('mostrar_librosusuarios',$datos);
    ...
    $this->load->view('mostrar_librosact',$datos);}
     ...
     public function mostraractualizacionautores()
     {
         ...
         if(isset( $_SESSION['nombre']) &&  $_SESSION['password']){
            ...
            $this->load->view('mostrar_autoresact',$datos);
